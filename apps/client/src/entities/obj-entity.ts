...
export class ObjEntity extends Entity {
  ...
  /**
   * Returns the current label text, or undefined if no label exists.
   */
  ...
  /**
   * Returns obstacle data for navmesh generation, or undefined if not collidable.
   */
  getNavmeshObstacle(): NavmeshObstacle | undefined {

import type { UiAnchor, UiViewport, UiWidgetLayout } from "./uiLayoutTypes";
...
export const clampWidgetOffsets = (
  ...
  const { left, top } = resolveTopLeft(layout.anchor, layout.offsetX, layout.offsetY, viewport, size);
  ...
  return resolveOffsetsFromTopLeft(
    layout.anchor,
    clampedLeft,
    clampedTop,
    viewport,

...
import { DEFAULT_WIDGET_LAYOUT } from "./uiLayoutDefaults";
import {
  clampWidgetOffsets,
...
import { UiLayoutManager, uiLayoutManager } from "./UiLayoutManager";
import type { UiWidgetLayout, UiWidgetLayoutPatch } from "./uiLayoutTypes";
...
export const useWidgetLayout = (
  ...
  const handlePointerDown = useCallback(
    (event: ReactPointerEvent<HTMLDivElement>) => {
      ...
      const clamped = clampWidgetOffsets(
        { ...widgetLayout, ...scaled },
        viewport,
        size,
      );

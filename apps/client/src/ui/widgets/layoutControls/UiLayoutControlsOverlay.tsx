...
import {
  uiLayoutManager,
  type UiLayoutImportMode,
} from "../../layout/UiLayoutManager";

const useLayoutSnapshot = () => {
  const subscribe = useCallback(
    (listener: () => void) => uiLayoutManager.subscribe(listener),
    [],
  );
    ...
    <div id="ui-layout-controls" data-ui-interactive="true">
      <div className="ui-layout-controls__header">
        <div>
          ...
          <div className="ui-layout-controls__subtitle">
            Toggle: L · Lock: U
          </div>
        </div>
        <button
          className="ui-layout-controls__close"
          type="button"
          onClick={handleClose}
        >
          Close
      ...
      <div className="ui-layout-controls__section">
        ...
        <div className="ui-layout-controls__import-row">
          <select
            ...
            value={importMode}
            onChange={(event) =>
              setImportMode(event.target.value as UiLayoutImportMode)
            }
          >
      ...
      {status ? (
        <div className="ui-layout-controls__status">{status}</div>
      ) : null}
    </div>
  );
};

...
import { StatsController } from "../../combat/statsController";
import { StatusController } from "../../combat/statusController";
import { STATUS_DEFINITIONS } from "../../combat/statusDefinitions";
...
export abstract class ServerMob<TState extends MobState> {
  ...
  dirX = 0;
  dirZ = 0;
  navmeshNodeRef: number | null = null;

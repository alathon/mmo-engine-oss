...
- `LineOfSightTracker` (`lineOfSightTracker.ts`) computes per-player visibility to nearby mobs.
...
### Tuning
If LoS costs get high, tune these constants in `lineOfSightTracker.ts`:
